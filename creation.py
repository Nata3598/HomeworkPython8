...
def create(name='', surname='', number='', email=''):
    ...
    if(name == ''):
        ...
        return
    if(surname == ''):
        print("Не указана фамилия пользователя")
        return
    if(number == ''):
        print("Не указан номер телефона пользователя")
        return
    if(email == ''):
        print("Не указана электронная почта пользователя")
        return
...
def update(id='', new_name='', new_surname='', new_number='', new_email=''):
    ...
    global db_file_name
    if(id == ''):
        print('указать id для обновления')
        return
